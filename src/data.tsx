...
const teachers: Teacher[] = [
  {
    ...
    bio: [
      ...
      "Tijekom tih godina vidjela sam koliko je učenicima izazovan prelazak iz osnovne u srednju školu, osobito kada je riječ o matematici. Novi ritam, veći pritisak, brži tempo gradiva… i zato vjerujem da je dobra priprema iznimno važna — daje sigurnost, mir i dobar start.",
      ...
      "Majka sam dvoje djece i znam koliko je važna podrška, strpljenje i topla riječ — jer s njima matematika postaje most, a bez njih ostaje zid.",
    ],
  },
  {
    fullName: "Tea Amižić",
    ...
    bio: [
      ...
      "U svom radu posebno se bavim radom s darovitim učenicima, koje pripremam za školska, županijska i državna natjecanja te se mogu pohvaliti mentorstvom učenika na svim razinama natjecanja. Također, kontinuirano pripremam učenike za Državnu maturu, sudjelujem u ispravljanju ispita Državne mature, kao i u ispravljanju prijemnih ispita iz matematike za upis u matematičke gimnazije, što mi omogućuje detaljan uvid u kriterije vrednovanja i najčešće pogreške učenika.",
      ...
      "Osim nastavnog rada, u V. gimnaziji pokretač sam Peta pub kviza, koji organiziram u suradnji s bivšim učenicima. Ovakvim projektima nastojim graditi pozitivnu i ugodnu atmosferu, poticati suradnju i razvijati pozitivan odnos prema školi i učenju.",
    ],
  },
];
